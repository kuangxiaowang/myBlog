...
```
柯里化理解：https://blog.csdn.net/weixin_47450807/article/details/123152265
通用柯里化函数：https://blog.csdn.net/wangyun_gogo/article/details/109453414
```
...
server {
    listen 80;
    server_name www.kuangxiaowang.top;
    #root /home/jiang/webWorks/website;
    #index /home.html;
    index index.html index.htm index.php;
  
    location /webfunny/ {
      proxy_pass http://47.242.123.189:8010/webfunny/;
      proxy_redirect default ;
    }
    # webfunny_server 数据接口等反向代理
    location /server/ {
        proxy_pass http://47.242.123.189:8011/server/;
...
server{
	listen  443 ssl;
	server_name www.kuangxiaowang.top;
	ssl_certificate   7684115_kuangxiaowang.top.pem;
	ssl_certificate_key 7684115_kuangxiaowang.top.key;
    index index.html index.htm index.php;
    #error_page 404 /404.html;
    #error_page 502 /502.html;
    # 数据接口等代理
    location /server/ {
        proxy_pass http://www.kuangxiaowang.top:8011/server/;
        proxy_connect_timeout 3000;
        proxy_send_timeout 3000;
        proxy_set_header Host $http_host;
        proxy_set_header X-Real-IP $remote_addr;
   ...
   location /webfunny/ {
        proxy_pass http://www.kuangxiaowang.top:8010/webfunny/;
        proxy_redirect default ;
    }
    location ~ [^/]\.php(/|$) {
      #fastcgi_pass remote_php_ip:9000;
...
server {
    listen 80;
    server_name www.kuangxiaowang.cn;
    #root /home/jiang/webWorks/website;
    #index /home.html;
    index index.html index.htm index.php;
    ...
    location /drawBed {
      ...
      try_files $uri $uri/ /drawBed/index.html;
    }
    location /wxk/ {
      proxy_pass http://8.218.74.44:8360/wxk/;
    }
    location /user/ {
      proxy_pass http://8.218.74.44:8360/user/;
    }
    location /project/ {
      proxy_pass http://8.218.74.44:8360/project/;
    }
   location /File/ {
      proxy_pass http://8.218.74.44:8360/File/;
    }
    location / {
      proxy_pass http://8.218.74.44:8080;
    }
}
server {
    listen 443 ssl;
    server_name www.kuangxiaowang.cn;
    ssl_certificate   7874825_www.kuangxiaowang.cn.pem;
    ssl_certificate_key 7874825_www.kuangxiaowang.cn.key;
    index index.html index.htm index.php;
...
server {
  ...
  location / {
    proxy_pass http://47.243.27.186:8001;
  }
}
server {
  listen 443 ssl;
  server_name www.kuangxiaowang.top;
  ssl_certificate   7684115_www.kuangxiaowang.top.pem;
  ssl_certificate_key 7684115_www.kuangxiaowang.top.key;
  index index.html index.htm index.php;
  location /elm {
    root /usr/local/nginx/html;
  }
